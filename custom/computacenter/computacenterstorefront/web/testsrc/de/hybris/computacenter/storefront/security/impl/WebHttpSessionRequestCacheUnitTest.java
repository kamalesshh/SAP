...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/computacenterstorefront/electronics/en",
						"https://electronics.local:9002/computacenterstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/computacenterstorefront/electronics/en",
						"https://electronics.local:9002/computacenterstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/computacenterstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/computacenterstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/computacenterstorefront/electronics/en",
						"https://electronics.local:9002/computacenterstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/computacenterstorefront",
						"https://electronics.local:9002/computacenterstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/computacenterstorefront",
						"https://electronics.local:9002/computacenterstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/computacenterstorefront/electronics/en",
						"https://electronics.local:9002/computacenterstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
