 ...
 */
package de.hybris.computacenter.fulfilmentprocess.test.jobs;
...
import de.hybris.computacenter.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ComputacenterFulfilmentProcessConstants.ORDER_PROCESS_NAME;
