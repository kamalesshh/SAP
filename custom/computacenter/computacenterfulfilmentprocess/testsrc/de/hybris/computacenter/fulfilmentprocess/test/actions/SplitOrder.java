 ...
 */
package de.hybris.computacenter.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ComputacenterFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ComputacenterFulfilmentProcessConstants.PARENT_PROCESS);
