 ...
 */
package de.hybris.computacenter.test.setup;
...
import de.hybris.computacenter.test.constants.ComputacenterTestConstants;
import de.hybris.computacenter.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ComputacenterTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/computacentertest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/computacentertest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/computacentertest/import/cstickets.impex");
			...
			importImpexFile(context, "/computacentertest/import/csquotes.impex");
		}
	}
}
