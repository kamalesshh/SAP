 ...
 */
package de.hybris.computacenter.core.suggestion;
...
import de.hybris.computacenter.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/computacentercore/test/testSimpleSuggestionService.csv", "utf-8");
	}
